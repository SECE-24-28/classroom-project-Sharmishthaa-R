        ...
        <div className="card p-8">
          <div className="text-center">
            <motion.div
              ...
              className="mx-auto h-16 w-16 bg-orange-700 rounded-full flex items-center justify-center mb-4"
            >
                ...
                <div className="flex space-x-4">
                  <label className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-orange-700 focus:ring-orange-700 border-gray-300"
                    />

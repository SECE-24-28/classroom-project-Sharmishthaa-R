        ...
        >
          {user ? (
            ...
            <>
              ...
              <p className="text-gray-600">Please login to proceed with recharge</p>
            </>
          )}
        </motion.div>
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                >
                  {!user ? <Lock className="h-5 w-5" /> : <Zap className="h-5 w-5" />}
                  <span>{!user ? 'Login to Recharge' : 'Recharge Now'}</span>
